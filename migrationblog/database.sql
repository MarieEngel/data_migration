...
--
-- Name: address_addressbook; Type: TABLE; Schema: public; Owner: user1
--
...
ALTER TABLE public.address_addressbook OWNER TO user1;

--
-- Name: address_addressbook_id_seq; Type: SEQUENCE; Schema: public; Owner: user1
--
...
ALTER TABLE public.address_addressbook_id_seq OWNER TO user1;

--
-- Name: address_addressbook_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user1
--
...
--
-- Name: address_addressbook id; Type: DEFAULT; Schema: public; Owner: user1
--
...
--
-- Data for Name: address_addressbook; Type: TABLE DATA; Schema: public; Owner: user1
--

COPY public.address_addressbook (id, name, phone, address) FROM stdin;
2	John	0090234923	Schulstr. 2, 05674 Neustadt
1	Jane	007292348783	Am Marktplatz 7, 09876 Neustadt
\.
...
1	pbkdf2_sha256$320000$aLuzSeGY9UUmJcWB4N6cxy$kSC1TW6IA5VS/Wc2VNFfwA0zGOdoq27o5ot6G6grlfc=	2022-02-02 11:48:41.149244+01	t	admin			admin@example.com	t	t	2022-02-02 11:18:53.225485+01
\.
...
1	2022-02-02 12:06:38.476884+01	1	AddressBook object (1)	1	[{"added": {}}]	7	1
2	2022-02-02 12:06:53.155832+01	2	AddressBook object (2)	1	[{"added": {}}]	7	1
3	2022-02-02 12:17:53.91483+01	2	AddressBook object (2)	2	[{"changed": {"fields": ["Address"]}}]	7	1
4	2022-02-02 12:18:30.688486+01	1	AddressBook object (1)	2	[{"changed": {"fields": ["Address"]}}]	7	1
\.
...
1	contenttypes	0001_initial	2022-02-02 11:16:33.62151+01
2	auth	0001_initial	2022-02-02 11:16:33.737701+01
3	admin	0001_initial	2022-02-02 11:16:33.787773+01
4	admin	0002_logentry_remove_auto_add	2022-02-02 11:16:33.794903+01
5	admin	0003_logentry_add_action_flag_choices	2022-02-02 11:16:33.803165+01
6	contenttypes	0002_remove_content_type_name	2022-02-02 11:16:33.823027+01
7	auth	0002_alter_permission_name_max_length	2022-02-02 11:16:33.832864+01
8	auth	0003_alter_user_email_max_length	2022-02-02 11:16:33.841916+01
9	auth	0004_alter_user_username_opts	2022-02-02 11:16:33.849007+01
10	auth	0005_alter_user_last_login_null	2022-02-02 11:16:33.857054+01
11	auth	0006_require_contenttypes_0002	2022-02-02 11:16:33.859081+01
12	auth	0007_alter_validators_add_error_messages	2022-02-02 11:16:33.865592+01
13	auth	0008_alter_user_username_max_length	2022-02-02 11:16:33.880025+01
14	auth	0009_alter_user_last_name_max_length	2022-02-02 11:16:33.888132+01
15	auth	0010_alter_group_name_max_length	2022-02-02 11:16:33.89732+01
16	auth	0011_update_proxy_permissions	2022-02-02 11:16:33.906348+01
17	auth	0012_alter_user_first_name_max_length	2022-02-02 11:16:33.913295+01
18	sessions	0001_initial	2022-02-02 11:16:33.925325+01
19	address	0001_initial	2022-02-02 12:04:52.160516+01
20	address	0002_addressbook_address	2022-02-02 12:16:32.32803+01
\.
...
1tofej3wrqw3pinwmzgjvn4xa7ydhfj4	.eJxVjMsOwiAQRf-FtSG8O7h07zeQgQGpGkhKuzL-uzbpQrf3nHNfLOC21rCNvISZ2JlJdvrdIqZHbjugO7Zb56m3dZkj3xV-0MGvnfLzcrh_BxVH_dbWJpwguVIyoFbJC0vokxNonIqA4CSQtJoEgjFCC480FdIgvY_KW_b-AOerN30:1nFDBp:X8L8p2gA46Njd0ePcZXt3vnoHUG_tYGtk7tTbGtkFQk	2022-02-16 11:48:41.15084+01
\.


--
-- Name: address_addressbook_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user1
--

SELECT pg_catalog.setval('public.address_addressbook_id_seq', 2, true);
...
--
-- Name: address_addressbook address_addressbook_pkey; Type: CONSTRAINT; Schema: public; Owner: user1
--
